...
obtained through \definend{fitting by least-squares}\index{least squares}
\begin{center}  \small
...
Some calculation
gives an intercept of $b=1.05$ and a slope
of $m= 0.18$.
\begin{center}  \small
...
There are a number of different sequences of times from competing standards
...
\begin{center} \small
  ...
  \end{tabular}  
\end{center}
We can use this data to predict the date for $240$ seconds, and 
...
\end{verbatim}
\end{indented}
Plotting the data along with the line of best fit
\begin{indented}\small
\begin{verbatim}
...
%    How far out-of-trend was Bob Beamon's record?
  \item 
    ...
    criticisms made of NASA's decision to launch was in the way the
    analysis of number of O-ring failures versus temperature was made
    (of course, O-ring failure caused the explosion).
    ...
    (An excellent discussion appears in \cite{Stats}.)
    \begin{answer}
      \begin{exparts}
  ...
  \item 
    ...
    \begin{exparts}
      ...
      \partsitem The asteroid belt between Mars and
        Jupiter is thought
        to be what is left of a planet that broke apart.
