...
\begin{exercises}
  \recommended \item
    ...
    \begin{answer}
       ...
       \begin{exparts*}
        \partsitem 
          $\displaystyle \frac{\colvec{2 \\ 1}\dotprod\colvec{3 \\ -2}}{%
                               \colvec{3 \\ -2}\dotprod\colvec{3 \\ -2}}
             \cdot\colvec{3 \\ -2}
           =\frac{4}{13}
             \cdot\colvec{3 \\ -2}
           =\colvec{12/13 \\ -8/13}$
        \partsitem 
          $\displaystyle \frac{\colvec{2 \\ 1}\dotprod\colvec{3 \\ 0}}{%
                               \colvec{3 \\ 0}\dotprod\colvec{3 \\ 0}}
             \cdot\colvec{3 \\ 0}
           =\frac{2}{3}
             \cdot\colvec{3 \\ 0}
           =\colvec{2 \\ 0}$
        \partsitem 
          $\displaystyle 
             \frac{\colvec{1 \\ 1 \\ 4}\dotprod\colvec{1 \\ 2 \\ -1}}{%
                   \colvec{1 \\ 2 \\ -1}\dotprod\colvec{1 \\ 2 \\ -1}}
             \cdot\colvec{1 \\ 2 \\ -1}
           =\frac{-1}{6}
             \cdot\colvec{1 \\ 2 \\ -1}
           =\colvec{-1/6 \\ -1/3 \\ 1/6}$
        \partsitem 
          $\displaystyle 
             \frac{\colvec{1 \\ 1 \\ 4}\dotprod\colvec{3 \\ 3 \\ 12}}{%
                   \colvec{3 \\ 3 \\ 12}\dotprod\colvec{3 \\ 3 \\ 12}}
             \cdot\colvec{3 \\ 3 \\ 12}
           =\frac{1}{3}
             \cdot\colvec{3 \\ 3 \\ 12}
           =\colvec{1 \\ 1 \\ 4}$
  ...
  \recommended \item 
    ...
    \begin{exparts*}
      \partsitem 
       $\colvec{2 \\ -1 \\ 4},~\set{c\colvec{-3 \\ 1 \\ -3}\suchthat c\in\Re}$
...
With those, and with
\nearbycorollary{cor:OrthAndBigEnoughIsBasis}, we will have that
...
(we can \definend{normalize}\index{normalize} the lengths).

\begin{example}
Normalizing the length of each vector in the orthogonal basis of
\nearbyexample{ex:OrthoBasisForReThree}
produces this \definend{orthonormal basis}.\index{basis!orthonormal}%
...
some computations.
See \nearbyexercise{exer:OrthoRepEasy}, for example.
...
in some contexts this is called the line \definend{normal}\index{normal} %
to the plane.
\end{example}
