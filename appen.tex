...
\makeatletter
\newcommand{\appendsection}[1]{\vspace{3ex plus .25ex minus .15 ex}\noindent{\addcontentsline{toc}{subsection}{#1}\large\textbf{#1}}\vspace*{1.5ex plus .1 ex minus .05 ex}\nopagebreak[4]\par\noindent\trim@spaces}
\makeatother
...
This section only outlines these topics,
...
% So this relation splits the natural numbers into
