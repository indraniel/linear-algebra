...
model:~what happens when $P$ looks down to the equator?
...
(This brings out that the dome is not quite an entire hemisphere 
or else
when the viewer is looking exactly along the equator then there are 
two points in the line on the dome. 
Instead we define the dome so that it is the
