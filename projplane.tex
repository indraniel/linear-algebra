...
\begin{center}
 ...
 \hfill\llap{($**$)}
\end{center}
% However, note that projective points on the equator don't project up to the 
% plane.
...
These are called \definend{ideal points}\index{ideal point}%
...
However, we don't have the same familiarity with the projective plane as
...
We finish by point out one more thing about the projective plane. 
