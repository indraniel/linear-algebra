...
map1,map2,map3,map4,map5,map6,lstsqs,homogeom,markov,erlang,,magicsqs,%
...
\include{map6}
\pagestyle{booktopic}
  \include{lstsqs} \include{homogeom} \include{markov} \include{erlang} \include{magicsqs}\pagestyle{bookbody}
\include{det1}
\include{det2}
\include{det3} 
\pagestyle{booktopic}
...
\include{jc4}
\pagestyle{booktopic}
  \include{powers} \include{pops} \include{recur} \pagestyle{bookbody}
%\include{eigengeom}
\include{appen}
