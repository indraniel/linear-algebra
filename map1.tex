...
With that, by
\nearbylemma{le:PresStructIffPresCombos} this map preserves
structure.
%</pf:IsoInvAlsoIso1>
\end{proof}
...
since an isomprphism map from $V$ to $W$ is paired with an isomorphism
from $W$ to $V$.
%</pf:IsoEquivRel1>
...
\nearbylemma{lem:IsoInvAlsoIso}, that if $f$ is an isomorphism 
