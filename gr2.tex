...
\begin{exercises}
  ...
  \puzzle \item 
    ...
    the position of the stars $2000$~years ago in the Hellenistic period.  
    ...
    \begin{answer}
      \begin{exparts}
        ...
        \item We want to maximize this.
          ...
          This Python program finds the largest angle.
          \begin{verbatim}
  import math
  days={1:31,  # Jan
  ...
  print "  That is ",180*res/math.pi,"degrees"
          ...
          The result is 
          \begin{verbatim}
  For  (7, 12) the worst case is 0.158740790753 radians on date (12, 1)
    That is  9.0951773467 degrees
\end{verbatim}
          We can get Sage to plot the angle for all the dates with this command
\begin{verbatim}
