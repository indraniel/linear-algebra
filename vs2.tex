...
as a span, 
as an unrestricted linear combination of some elements.
...
The next result describes when adding a vector to a set increases its
span.
...
By \nearbylemma{lm:ExpandSpanByAddingNonRepeat} the span does not
...
In addition to describing the interaction between linear
...
It shows that some 
linearly independent sets are maximal in
