...
% first two $c_1\vec{v}_1+c_2\vec{v}_2=\zero$ if $c_1=0$ and $c_2=0$.
...
\begin{equation*}
  S=\set{\colvec[r]{1 \\ 0 \\ 0},
     ...
     \colvec[r]{3 \\ 3 \\ 0}  }
\end{equation*}
We will find vectors to drop to get a subset that is independent but that
has the same span.
...
\begin{exercises}
  ...
  \recommended \item  
    ...
    \end{answer}
  \item 
    Consider the set of functions from the open interval $(-1..1)$ of reals 
    to $\Re$.
    \begin{exparts}
      \partsitem Show that 
