...
\begin{center}
  ...
  \begin{tabular}{r|l}
    ...
    &\multicolumn{1}{l}{{\renewcommand{\arraystretch}{1.0}
      ...
      \end{tabular}}}                \\ \hline
    $\text{Democrat} > \text{Republican} > \text{Third}$ &5     \\
    $\text{Democrat} > \text{Third} > \text{Republican}$ &4     \\
    $\text{Republican} > \text{Democrat} > \text{Third}$ &2     \\
    $\text{Republican} > \text{Third} > \text{Democrat}$ &8     \\
    $\text{Third} > \text{Democrat} > \text{Republican}$ &8     \\
    $\text{Third} > \text{Republican} > \text{Democrat}$ &2     \\ \hline
    total                                                &29
  \end{tabular}
...
%  \psset{xunit=10pt,yunit=10pt,runit=10pt} 
%   \pspicture(-3.1,-3.5)(3,3.75) %\psgrid(-1,-1)(1,1)
%     \SpecialCoor
%     \rput(3;90){\small Democrat}
%     \psarc{->}(0,0){3}{-10}{50}
%        \rput[lb](3.1;20){\scriptsize $5$ voters} 
%     \rput[B](3;210){\small Third}
%     \psarc{->}(0,0){3}{220}{320}
%        \rput[t](3.1;270){\scriptsize $1$ voter} 
%     \rput[B](3;330){\small Republican}
%     \psarc{->}(0,0){3}{130}{190}
%        \rput[rb](3.1;160){\scriptsize $7$ voters} 
%   \endpspicture
\end{center}
This is an example of a \definend{voting paradox}\index{voting paradox},
specifically, a
\definend{majority cycle}.\index{voting paradox!majority cycle}

Voting paradoxes are studied in part because of their 
...
%   \pspicture[.5](-9,-4.2)(9,4) %\psgrid(-10,-10)(10,10)
%     \SpecialCoor
%     \rput(3;90){\small $D$}
%     \psarc{->}(0,0){3}{10}{70} %-rd->
...
\begin{equation*}
  ...
  % {\mathord{\raisebox{-.2in}{\includegraphics{voting.43}}}}
  %\includegraphics{voting.43}
...
(see \nearbyexercise{exer:PerpIsSubSp}) of vectors that are 
...
=
\votinggraphic{4}
% \votecycle{1/3}{1/3}{1/3}{4}
+
\votinggraphic{5}
%\votecycle{2/3}{2/3}{-4/3}{4}
\end{equation*}
...
%          \endpspicture
  ...
  \item \label{exer:VoterCondNotSuff} 
    The necessary condition that is proved above---a
