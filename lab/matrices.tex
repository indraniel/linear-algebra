...
\inlinecode{TypeError: unsupportedoperand parent(s) for '*'}, meaning that
...
In fact, matrix multiplication is very noncommutative 
...
\protect\inlinecode{g.save("graphics/mat001.png", figsize=[2.25,1.5], axes_pad=0.05, fontsize=7, dpi=500)}.
