...
For instance, the first graphic was generated with \protect\inlinecode{g1 = scatter_plot(d, markersize=10, facecolor='#b9b9ff')}.
It was saved with \protect\inlinecode{g1.save("../inverse_initial.png", figsize=[2.25,1.5], axes_pad=0.05, fontsize=7, dpi=500)}.}
\begin{center}
