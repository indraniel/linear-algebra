...
Because this ellipsoid is closed and bounded it has (at least one) 
...
The picture shows that if we slide the tangent plane~$P$ along the 
vector~$\vec{v}$ to
...
There is a unique plane that touches the ellipsoid
...
So keeping all the terms would require $500\cdot(2cdot 500+1)=500\,500$~reals,
