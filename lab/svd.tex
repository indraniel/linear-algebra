...
q = plot_circle_action(1,0,0,1) 
q.set_axes_range(-2, 4, -3, 6) 
q.save("graphics/svd005a.png",figsize=3)
p = plot_circle_action(1,2,3,4) 
p.set_axes_range(-2, 4, -3, 6) 
p.save("graphics/svd005b.png",figsize=3)
\end{sagesilent}
\begin{equation*}
...
\end{sagesilent}
\begin{center}
  \includegraphics{graphics/svd100.png}
\end{center}
...
The issue is whether you lose too much of the the information by only 
retaining the information associated with some of the singular values.

To ilustrate that you can succeed in retaining at least some aspects of data
...
% The quality may (or may not) be acceptable, depending on the application.
