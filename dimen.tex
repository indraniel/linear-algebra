...
However,
it is not correct in other unit systems;  
...
\end{equation*}  
Now the physics equation holds in the yard-second system   
\begin{equation*}
  \text{distance in yards}=16\,\frac{(1/3)\,\text{yd}}{\text{sec}^2}
                   ...
                   =\frac{16}{3}\,\frac{\text{yd}}{\text{sec}^2}
                    \cdot (\text{time in sec})^2
\end{equation*}
because when we align the units, the $16$~gets the correct adjustment.
