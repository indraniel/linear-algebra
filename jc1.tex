...
the first section is a quick review of complex numbers.
%</ReasonForShiftToComplexNumbers>
...
\subsectionoptional{Review of Factoring and Complex Numbers}
...
\definend{complex numbers}\index{complex numbers}
\( \C \).
