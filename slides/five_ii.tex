...
% \end{equation*}
% Suppose $T=\rep{t}{\stdbasis_2,\stdbasis_2}$ for $\map{t}{\Re^2}{\Re^2}$.
% We want a basis $B=\sequence{\vec{\beta}_1,\vec{\beta}_2}$ such that
% the matrix $\rep{t}{B,B}$ is diagonal.
...
% \end{equation*}
% \pause
% So we want to find $\lambda_1$ and $\lambda_2$ making these two true.
% \begin{equation*}
%   \begin{mat}
%     3  &1  \\
%     1  &3    
...
% \end{frame}
% \begin{frame}
% \noindent We want scalars $x\in\C$ such that this system
% \begin{equation*}
%   \begin{mat}
%     3  &1  \\
%     1  &3    
...
%   \tag{$*$}
% \end{equation*}
% has a solution if this determinant is nonzero.
% \begin{equation*}
%   \begin{vmat}
%     3-x  &1  \\
%     1    &3-x
...
% \end{equation*}
% \pause
% To compute a basis consider first the $x=2$ version of~($*$).
% \begin{equation*}
%   \begin{linsys}{2}
%     1\cdot b_1 &+ &b_2        &= &0 \\
%     b_1        &+ &1\cdot b_2 &= &0 
...
%   b_1=-b_2
% \end{equation*}
% For instance we can take $b_1=1$ and $b_2=-1$.
% \end{frame}
% \begin{frame}\vspace*{-1ex}
% \noindent To get a second basis vector do the $x=4$ version of~($*$).
% \begin{equation*}
%   \begin{linsys}{2}
%     -1\cdot b_1 &+ &b_2        &= &0 \\
%     b_1        &- &1\cdot b_2 &= &0 
...
Of course, $S=PTP^{-1}$ represents the same function, but 
