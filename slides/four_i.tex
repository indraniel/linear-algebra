...
makes the computations awkward and slow.
But it is useful for theory since it makes easier the proof that 
determinants are well-defined.
\end{frame}
...
\begin{frame}
We can use multilinearity to break a determinant into a sum of 
simple ones.
