...
\begin{frame}
\noindent This 
shows that projected-to vector with a red body.
...
line so the red vector $\proj{\vec{v}}{\spanof{\vec{s}\,}}$ is quite short
...
\iftoggle{showallproofs}{
  ...
  We will instead illustrate the argument in the next example.
}
\end{frame}
\iftoggle{showallproofs}{
  \begin{frame}
