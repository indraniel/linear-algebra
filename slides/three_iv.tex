...
\end{equation*}
Thus, on the same input vector, 
compared with the representation of the output
vector from~$f$, the 
representation of the output 
vector from function $6f$ has entries that are
$6$ times as big.
...
\end{equation*}
\pause
The prior slide shows that on the same input the matrix representing $6f$ 
does this.
\begin{equation*}
  \rep{6f}{B,D}\cdot
  \colvec{v_1 \\ v_2}
...
\end{equation*}
Therefore this matrix represents the map $\map{6f}{V}{W}$.
\begin{equation*}
  \rep{6f}{B,D}
  =
  \begin{mat}
...
\pause
We will develop the representation of the action of $\composed{g}{h}$ by 
...
\end{frame}
\begin{frame}
\noindent Apply $g$ to that vector's representation.
\begin{multline*}
...
\setlength{\fboxsep}{1.5pt}
    \begin{mat}
       ...
       {\color{magenta} \begin{array}{@{}cc@{}} 0  &1 \end{array}}           \\ 
    ...
    \begin{mat}
      ...
      &{\color{magenta}\begin{array}{@{}c@{}}  6  \\  7  \end{array}}
