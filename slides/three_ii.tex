...
Now, for some vectors $\vec{w}\in W$
in the range there may be many vectors $\vec{v}\in V$ mapped to $\vec{w}$.
(Below, to avoid a confused picture there is only one `$\mapsto$' arrow for 
