...
angle~$\Theta$.
These drawings show that this map preserves addition 
\begin{center}
  \vcenteredhbox{\includegraphics[width=.3\textwidth]{asy/three_ii_rotate_sum_before.pdf}}
  \qquad$\mapsunder{t_{\pi/6}}$\qquad
  \vcenteredhbox{\includegraphics[width=.3\textwidth]{asy/three_ii_rotate_sum_after.pdf}}
\end{center}
and scalar multiplication.
\begin{center}
  \vcenteredhbox{\includegraphics[width=.3\textwidth]{asy/three_ii_rotate_prod_before.pdf}}
  \qquad$\mapsunder{t_{\pi/6}}$\qquad
  \vcenteredhbox{\includegraphics[width=.3\textwidth]{asy/three_ii_rotate_prod_after.pdf}}
\end{center}
Using the lemma we will give a formula for $t_\Theta$.
\end{frame}
\begin{frame}
...
\begin{equation*}
  \vcenteredhbox{\includegraphics[width=.3\textwidth]{asy/three_ii_rotate_basis.pdf}}
  \qquad
