...
then
  ...
  declare -a pdf_out_files=("two_i_plane" "r3_subspaces" "r3_subspaces_spans" "p2_subspaces" "p2_subspaces_spans" "two_i_a_line" "two_i_a_plane" "three_i_line" "three_ii_kernel" "three_ii_rotate_basis" "three_ii_rotate_sum_before" "three_ii_rotate_sum_after" "three_ii_rotate_prod_before" "three_ii_rotate_prod_after" "three_ii_3dproj1" "three_ii_3dproj2" "three_ii_3dproj3" "three_ii_dims" "three_vi_3dprojtoline" "three_vi_3dgramschmidt0" "three_vi_3dgramschmidt1" "four_ii_orientation"  "four_ii_orientation_pos" "four_ii_orientation_neg four_ii_negvolbox")
  cmd="asy -f pdf filename"  # will substitute for "filename"
